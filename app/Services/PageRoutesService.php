...
//
// Syncing and consistencies should be handled via the service.
...
class PageRoutesService
{
    ...
    public function findPageOrFail(string $uri): Page
    {
        ...
        // If the page doesn't exist, we know getPageIdFromUri
     ...
     */
    protected function updateUrlsAndDescendantsOf(Page $page, array &$uriToIdMapping): void
    {
     ...
     * @param  array  $uriToIdMapping  - The URI -> ID mapping (as a reference, to be modified in-place)
     */
    protected function unsetOldUrlsOf(Page $page, array &$uriToIdMapping): void
    {
